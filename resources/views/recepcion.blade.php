...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* ============================================================
           HEADER — espejo exacto de captura.jpg
        ============================================================ */
        .header-wrap {
            width: 100%;
        ...
        /* Línea divisoria azul gruesa */
        .divider {
            border: none;
            border-top: 2.5px solid #10213E;
            margin: 8px 0 10px;
        }

        /* ============================================================
           SECTION TITLES — fondo azul oscuro texto blanco
        ============================================================ */
        .section-title {
        ...
        .info-table .val-strong {
            font-weight: 700;
            color: #1a1a2e;
        }

        /* ============================================================
           VEHICLE CONDITION — testigos + combustible
        ============================================================ */
        .condition-outer {
            width: 100%;
            border-collapse: collapse;
        ...
        .service-table thead tr th.center {
            text-align: center;
        }
        ...
        .service-table tbody tr td.center {
            text-align: center;
            color: #888;
        }
        ...
        .photo-header {
            width: 100%;
            border-collapse: collapse;
            border-bottom: 2.5px solid #10213E;
            padding-bottom: 8px;
            margin-bottom: 12px;
        }
...
<div class="page">
        ...
        <tr>
            ...
            <td class="witnesses-cell">
                ...
                @foreach($icons as $key => $label)
                    ...
                    <div class="icon-box">
                        <img
                            src="{{ public_path('images/icons/' . $key . '.svg') }}"
                            class="icon-img {{ !$active ? 'icon-inactive' : '' }}"
                            alt="{{ $label }}"
                        >
                        <div class="{{ $active ? 'icon-label-active' : 'icon-label-inactive' }}">
                            {{ $label }}
                        </div>
                    </div>
                @endforeach
    ...
    <table class="service-table">
        ...
        <tbody>
            {{-- Fila de síntomas reportados por el cliente --}}
            <tr>
                <td>
            ...
            {{-- Filas en blanco para anotaciones manuales (como momento.pdf) --}}
            @for ($i = 0; $i < 10; $i++)
            <tr>
                <td>&nbsp;</td>
                <td class="center"></td>
...
<div class="page page-break">
        ...
        <tr>
            <td>
                ...
                <div class="photo-client-sub">
                    Client: {{ strtoupper($recepcion->client?->first_name . ' ' . $recepcion->client?->last_name) }}
                </div>
            </td>
        ...
        <table style="width: 100%; border-collapse: collapse;">
            ...
            <tr>
                ...
                <td style="text-align: center; padding: 8px; border: none;">
                    <img
                        src="{{ public_path('storage/' . str_replace('\\', '/', $photo)) }}"
                        class="photo-img"
                        alt="Vehicle photo"
                    >
                </td>
                @endforeach
                {{-- Si la fila tiene 1 sola foto, celda vacía para balance --}}
                @if(count($row) === 1)
    ...
    <div class="page-footer-bar">
        <table style="width: 100%; border-collapse: collapse;">
            <tr>
                <td>
                    <strong>{{ $settings->company_name }}</strong> | {{ $settings->address }}
                </td>
