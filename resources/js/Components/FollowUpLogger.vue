        ...
        <div class="bg-white rounded-xl shadow-sm border-l-4 border-[#EE2857] p-6">
            ...
            <div class="space-y-3 mb-6">
                ...
                <div>
                    ...
                    <!-- Zona de carga -->
                    <label class="flex flex-col items-center justify-center w-full border-2 border-dashed border-gray-300 rounded-lg py-4 cursor-pointer hover:border-[#10213E] hover:bg-gray-50:bg-gray-700 transition">
