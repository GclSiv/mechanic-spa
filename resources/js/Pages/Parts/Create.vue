...
const form = useForm({
    name: '', sku: '', cost_price: '', sale_price: '', stock: 0, low_stock_threshold: 2,
});

function submit() { form.post(route('parts.store')); }
</script>

<template>
    <AuthenticatedLayout title="Nueva Refacción">
        <template #header>
                ...
                <div class="bg-white rounded-xl shadow-sm overflow-hidden">
                    ...
                    <div class="p-6 space-y-5">
                        ...
                        <div>
                            ...
                            <input v-model="form.sku" type="text" placeholder="Ej. FIL-OIL-001"
                        ...
                        <div class="flex gap-3 pt-4 border-t border-gray-100">
                            ...
                            <button @click="submit" :disabled="form.processing"
                                ...
                                {{ form.processing ? 'Guardando...' : 'Registrar Refacción' }}
                            </button>
                        </div>
                    </div>
                </div>
