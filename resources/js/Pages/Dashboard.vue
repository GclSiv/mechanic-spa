        ...
        <div class="py-12 bg-gray-50">
            ...
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8 space-y-6">
                <div v-if="$page.props.flash.success"
                    class="mb-6 bg-green-50 border-l-4 border-green-500 p-4 rounded-r-lg shadow-sm flex items-center justify-between transition-all duration-500">
                    ...
                    <button @click="$page.props.flash.success = null" class="text-green-400 hover:text-green-600">
                    ...
                    <div class="p-8 text-gray-900">
                        ...
                        <div class="mb-8 flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                            ...
                            <div class="flex flex-col sm:flex-row items-center gap-4 w-full lg:w-auto">
                                <a :href="route('recepcion.export')" target="_blank"
                                    class="bg-green-600 hover:bg-green-700 text-white px-5 py-2.5 rounded-xl text-sm font-bold flex items-center gap-2 transition-all shadow-sm w-full sm:w-auto justify-center">
                                ...
                                <div class="relative w-full sm:w-80">
                                    <span class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                        <svg v-if="!isSearching" class="w-5 h-5 text-gray-400" fill="none"
                                    ...
                                    <tr v-for="client in recentClients" :key="client.id"
                                        ...
                                        <td class="p-4">
                                            <span class="bg-gray-100 px-2 py-1 rounded text-xs font-mono text-gray-700">
                                                {{ client.brand?.name || 'S/M' }} / {{ client.vehicleModel?.name ||
                                                    'S/M' }}
                                            </span>
                                        </td>
                                        <td class="p-4">
                                        ...
                                        <td class="p-4 flex justify-end gap-2">
                                            ...
                                            <Link :href="route('recepcion.edit', client.id)" title="Editar Registro"
                                                class="bg-gray-100 hover:bg-yellow-500 hover:text-white p-2 rounded-lg text-sm transition-all shadow-sm">
                                                ✏️
                                            </Link>

                                            <button @click="deleteRecord(client.id)" title="Eliminar Registro"
